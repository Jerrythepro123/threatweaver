...
| File | |
|---|---|
| [Features & Combinations](features.md) | Every backend/stage combination, recipe profiles, and how config lets the team mix models per stage. |
| [Features & Capabilities (one-page)](capabilities.md) | Single-page overview of the pipeline, backends, and capabilities. |
